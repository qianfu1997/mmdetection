...
model = dict(
    ...
    rpn_head=dict(
        ...
        feat_channels=256,
        anchor_scales=[8],
        anchor_ratios=[0.2, 0.5, 1.0, 2.0, 5.0, 8.0],
...
train_cfg = dict(                   # first use the baseline 0.5, 0.6, 0.7
    rpn=dict(
        assigner=dict(
            type='MaxIoUAssigner',
            pos_iou_thr=0.7,
    ...
    stage_loss_weights=[1, 1, 1])      # weight [1, 1, 1] according to wwh
test_cfg = dict(
    rpn=dict(
