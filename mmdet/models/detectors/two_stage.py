...
class TwoStageDetector(BaseDetector, RPNTestMixin, BBoxTestMixin,
    ...
    def forward_train(self,
        ...
        if self.with_bbox:
            ...
            rois = bbox2roi([res.bboxes for res in sampling_results])   # for each img.
        ...
        # mask head forward and loss ori version
        ...
        if self.with_mask:
            ...
            # pos_labels are the corresponding gt label of pos gt.
